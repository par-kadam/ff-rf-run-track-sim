...
% Check the units of the marker coordinates, only if the file contains marker data!
if 0 < length(fieldnames(marker_data.Markers))
    ...
    fprintf("%s file contains no marker data!", file);
end
...
marker_data.Time = ( ...
    1/marker_data.Info.frequency : 1/marker_data.Info.frequency : marker_data.Info.NumFrames/marker_data.Info.frequency)';
