...
if isempty(GRFFile)
    ...
    V.ExternalLoads.datafile=GRFFile;
end

if isempty(MOTFile)
    V.ExternalLoads.external_loads_model_kinematics_file= ' ';
else 
    V.ExternalLoads.external_loads_model_kinematics_file=MOTFile;
end
