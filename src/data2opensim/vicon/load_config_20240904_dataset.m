...
config.force_plate_data.cutoffFrequency  = 20; % Cutoff frequency in Hz
...
%    'RASI'; 'RPSI'; 'RTHI'; 'RKNE'; 'RTIB'; 'RANK'; 'RHEE'; 'RTOE';};
 ...
 config.marker_data.marker_list = {
     'LASI'; 'LPSI'; 'LTHI'; 'LKNE'; 'LTIB'; 'LANK'; 'LHEE'; 'LTOE'; 'LMT5'; 'LMAnkle'; 'LSH1'; 'LSH2'; 'LSH3'; 'LTH1'; 'LTH2'; 'LTH3'; 'LClavicle'; ...
     'RASI'; 'RPSI'; 'RTHI'; 'RKNE'; 'RTIB'; 'RANK'; 'RHEE'; 'RTOE'; 'RMT5'; 'RMAnkle'; 'RSH1'; 'RSH2'; 'RSH3'; 'RTH1'; 'RTH2'; 'RTH3'; 'LAPX1'; 'RAPX1'; ...
     'LShoulder'; 'LBiceps'; 'LElbow'; 'LMElbow'; 'LForearm'; 'LWrist';'RShoulder'; 'RBiceps'; 'RElbow'; 'RMElbow'; 'RForearm'; 'RWrist';};
...
name_muscles   = { 'right_soleus', 'right_peroneus', 'right_gastrocnemius_medialis', 'right_gastrocnemius_lateralis', 'right_tibialis_anterior', 'right_rectus_femoris', 'right_biceps_femoris', 'right_gluteus_maximus', 'right_tensor_fascia_lata',};
channels.sub01 = {     'R_Soleus',     'R_Peroneus',                'R_Med__Gastro',                 'R_Lat__Gastro',              'R_Tib_Ant_',        'R_Rectus_Fem_',        'R_Biceps_Fem_',           'R_Glut_Max_',             'R_Tensor_Fl_',};
...
config.length_min_gait_cycle       = 200;
config.length_max_gait_cycle       = 500;
config.export_only_first_n_cycles  =   3;
