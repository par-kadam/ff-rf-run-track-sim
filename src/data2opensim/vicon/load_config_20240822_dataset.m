function config = load_config_20240822_dataset()
...
config.path_dataset = '/home/lisca/biomec/data/20240822_dataset/';
...
% config.marker_data.marker_list = {
%     'LASI'; 'LPSI'; 'LTHI'; 'LKNE'; 'LTIB'; 'LANK'; 'LHEE'; 'LTOE'; 'L_ToeLat'; 'L_AnkMed'; 'L_TibAntSup'; 'L_TibPostSup'; 'L_FemAntInf'; 'L_FemAntSup'; ...
%     'RASI'; 'RPSI'; 'RTHI'; 'RKNE'; 'RTIB'; 'RANK'; 'RHEE'; 'RTOE'; 'R_ToeLat'; 'R_AnkMed'; 'R_TibAntSup'; 'R_TibPostSup'; 'R_FemPostSup'; 'R_FemAntSup'};
