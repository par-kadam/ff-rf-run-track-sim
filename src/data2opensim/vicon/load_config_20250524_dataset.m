function config = load_config_20250524_dataset()
...
config.marker_data.marker_list = {
    ...
    'RASI'; 'RPSI'; 'RTHI'; 'RKNE'; 'RTIB'; 'RANK'; 'RHEE'; 'RTOE'; 'RMAnkle'; 'RSH1'; 'RSH2'; 'RTH1'; 'RTH2'; 'RTH3'; ...
...
channels.sub04 = {                     'R_Soleus',                'R_Med__Gastro',                 'R_Lat__Gastro',            'R_Peroneus',              'R_Tib_Ant_',        'R_Biceps_Fem_',        'R_Rectus_Fem_',              'R_Tensor_Fl_'};

maximum_contraction_trials.sub04 = ...
...
config.emg_data.subjects.muscles = containers.Map( ...
    name_subjects, {...
        containers.Map(config.emg_data.name_muscles, channels.sub04),});

config.emg_data.maximum_contractions = containers.Map( ...
    name_subjects, {...
        containers.Map(config.emg_data.name_muscles, maximum_contraction_trials.sub04),});
...
config.length_min_gait_cycle       = 500;
config.length_max_gait_cycle       = 1000;
...
config.path_model_physics_fitted = fullfile(pwd, "../../../data/20250306_dataset/sub04/sub04_addbiomechanics/Models/match_markers_and_physics.osim");
conifg.update_model_path = "../../../data/20250306_dataset/sub04/ses20250524/";
config.results_directory = [config.path_dataset 'sub04/ses20250524/'];
