...
# print('packages {}'.format(find_packages(where='.')))

setup(
    name='athlete',
    version=VERSION,
    author='Audi-Konfuzius Institut Ingolstadt',
    description='A toolkit for reproducible reinforcement learning research in the context of the biomechanics of the human body',
    url='https://github.com/rlworkgroup/garage',
    packages=find_packages(where='.'),
    package_dir={'': '.'},
# todo(lisca): fix data copy when installing.
    package_data={'': ['data/rajagopal_2015_scale_1.0_calibrated_imu_14_ik.sto']},
